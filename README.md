...
## The Data
The file `tweet_data.csv` is a dataset containing tweets posted by contributors at a SXSW conference about Google, Apple, or Android. The columns in the original spreadsheet are as follows:
